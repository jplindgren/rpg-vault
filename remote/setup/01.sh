...
USERNAME=rpg_manager
# Prompt for AWS credentials.
read -p "Enter aws key: " AWS_KEY
read -p "Enter aws secret: " AWS_SECRET
...
# Add a AWS Credentials to the system-wide environment
# variables in the /etc/environment file.
echo "AWS_ACCESS_KEY_ID='${AWS_KEY}'" >> /etc/environment
echo "AWS_SECRET_ACCESS_KEY='${AWS_SECRET}'" >> /etc/environment
